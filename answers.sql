...
SELECT models.name, brand_name, brands.headquarters FROM models JOIN brands ON (models.brand_name = brands.name) WHERE models.name = 'Mustang';
...
SELECT models.name, brand_name, founded FROM models LEFT JOIN brands ON (models.brand_name = brands.name) WHERE year = 1960;
